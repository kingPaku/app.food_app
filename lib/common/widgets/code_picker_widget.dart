          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                hideHeaderText: false, // Add this parameter
                headerAlignment: MainAxisAlignment.center, // Add this parameter
                headerTextStyle: widget.textStyle ?? Theme.of(context).textTheme.titleLarge ?? const TextStyle(), // Add this parameter
                topBarPadding: const EdgeInsets.all(8.0), // Add this parameter
              ),
            ),
          ),
        ),
      ...
      showModalBottomSheet(
        ...
        builder: (context) => Center(
          child: SelectionDialog(
            ...
            headerTextStyle: widget.textStyle ?? Theme.of(context).textTheme.titleLarge ?? const TextStyle(),
